        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center items-center gap-6">
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/lyftup"
                target="_blank"
              ...
              {/* Instagram */}
              <a
                href="https://instagram.com/lyftup"
                target="_blank"
                rel="noopener noreferrer"
                className="group transition-all duration-300 hover:scale-110"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/lyftup"
                target="_blank"
                rel="noopener noreferrer"
                className="group transition-all duration-300 hover:scale-110"
                aria-label="Facebook"
          ...
          <div className="pt-6 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                ...
                <span>info@lyftup.com</span>
              </div>
              <div className="flex items-center gap-2">
                <Icon icon="mdi:phone" className="w-4 h-4 text-paan-blue" />
