...
const HomePage = () => {
  ...
  return (
    <>
    <SEO
        title="Media Seal | Certified PAAN Creative Marketing Agency | Nigeria"
        description="Media Seal is a certified member of the Pan-African Agency Network (PAAN), specializing in strategic marketing, advertising, media relations, and Campaign Conceptualization in Nigeria."
        keywords="Nigeria, Media Seal, PAAN, certified agency, media relations, creative marketing, advertising, strategic marketing, event management, communication, research, Cairo, creative services"
      />
      ...
      <main className="px-3 pt-6 sm:px-0 sm:pt-0 relative">
        ...
        <div className="relative w-full min-h-screen bg-white" id="home" ref={sectionRefs.home}>
          ...
          <section className="flex flex-col items-center justify-center min-h-screen relative z-10 px-4 sm:px-8 lg:px-16">
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex flex-wrap justify-center items-center gap-2 sm:gap-3 bg-white/80 rounded-full px-2 sm:px-4 py-1.5 sm:py-2 shadow-md w-[50%] sm:w-[20%] max-w-3xl text-xs sm:text-base">
              ...
              <div className="order-2 md:order-1">
                <div className="space-y-8">
                  ...
                  <p className="text-lg sm:text-xl leading-relaxed text-paan-dark-blue/90 font-light">
                    Media Seal is part of a global network of marketing service providers called Worldwide Partners International (WPI) with over 60+ Agencies in 40 countries in 5 continents. 
                    A dedicated team in diverse disciplines with access to a library of resources with winning case studies in their network.
                  </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-paan-dark-blue rounded-full"></div>
                          <span className="text-paan-dark-blue/90">Buying Optimization</span>
                        </div>
                        <div className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-paan-dark-blue rounded-full"></div>
                        ...
                        <div className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-paan-dark-blue rounded-full"></div>
                          <span className="text-paan-dark-blue/90">Programmatic DOOH</span>
                        </div>
                        <div className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-paan-dark-blue rounded-full"></div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-black/20 backdrop-blur-sm border border-white/10">
                    <video
                      ...
                      preload="metadata"
                    >
                      <source src="/assets/images/certified-members/media_seal/video.mp4" type="video/mp4" />
                ...
                <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8">
                  ...
                  <div className="flex-1">
                    ...
                    <blockquote className="text-xl sm:text-2xl font-medium text-gray-800 leading-relaxed mb-8 italic">
                        Every campaign is a chance to tell a powerful story. 
                        At Media Seal, we blend insight, creativity, and precision to ensure your brand isn’t just seen, but remembered
                    </blockquote>
        ...
        <div className="text-center space-y-8">
          ...
          {/* Social Media Links */}
            ...
            <div className="flex justify-center items-center gap-6">
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/mediaseal-wpi"
                target="_blank"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/mediasealss"
                target="_blank"
                rel="noopener noreferrer"
                className="group transition-all duration-300 hover:scale-110"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/MediaSeal/"
                target="_blank"
                rel="noopener noreferrer"
                className="group transition-all duration-300 hover:scale-110"
                aria-label="Facebook"
          ...
          <div className="pt-6 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                ...
                <span>mediaseal@mediaseal-ng.com</span>
              </div>
              <div className="flex items-center gap-2">
