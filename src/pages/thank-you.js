        ...
        <div className="flex-grow flex items-center justify-center px-4 py-16 mt-20">
          <div className="text-center max-w-2xl">
            ...
            <p className="text-gray-600 mb-6">
              Your Expression of Interest has been received. Please be patient while we process your submission. If we require any further information, we will contact you soon.<br/>
              In the meantime, feel free to explore more about PAAN or return to the homepage.
            </p>
