  ...
  return (
    <>
      ...
      <main className="px-3 pt-6 sm:px-0 sm:pt-0 relative">
        ...
        <div className="mx-auto max-w-6xl relative" id="about-us">
  {/* Individual Dots */}
...
<div className="bg-[#D1D3D4] relative" id="our-tier">
  {/* Individual Dots */}
  <div className="absolute -bottom-8 right-32 w-16 h-16 bg-[#84C1D9] rounded-full z-0"></div> {/* Blue dot, 44x44px */}
  ...
  <section className="relative z-10 mx-auto max-w-6xl py-20">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <Tier3 />
        ...
        <div className="mx-auto max-w-6xl mt-20 pb-20" id="events">
          <section>
        ...
        <div className="network-bg relative">
          ...
          {/* Content */}
          <section
            className="relative z-10 mx-auto max-w-6xl py-28 px-6"
            id="join-network"
          >
        ...
        <div className="mx-auto max-w-6xl mt-20 relative" id="contact-us">
  {/* Individual Dots */}
