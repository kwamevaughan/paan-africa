...
const AgencyEnquiryModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-xl w-full relative overflow-hidden shadow-xl">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold text-[#172840] mb-2">Enquire About PAAN</h2>
