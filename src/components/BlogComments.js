...
const BlogComments = ({ blogId }) => {
  ...
  useEffect(() => {
    if (blogId) {
      console.log("BlogComments: Fetching comments for blogId:", blogId);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          {/* Comments List - Takes 2 columns on xl screens */}
          ...
          {/* Comment Form - Takes 1 column on xl screens */}
            ...
            <div className="sticky top-8">
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="mt-6">
                    <div className="flex justify-center">
                      <ReCAPTCHA
                        ...
                        onChange={() => setFormErrors(prev => ({ ...prev, captcha: false }))}
                        onExpired={() => setFormErrors(prev => ({ ...prev, captcha: true }))}
                      />
                    </div>
                    {formErrors.captcha && (
                  ...
                  <button
                    type="submit"
                    className={`w-full mt-8 inline-flex items-center justify-center px-6 py-4 rounded-xl font-semibold text-white transition-all duration-300 transform ${
                      isSubmitting
                ...
                <p className="text-xs text-slate-500 mt-4 text-center">
                  Fields marked with <span className="text-[#F25849]">*</span>{" "}
                  are required. Your email will not be published.
                </p>
              </div>
            </div>
          </div>
