...
const PartnerWithUsButton = ({ 
  ...
  const variants = {
    ...
    white: "bg-transparent border border-white text-white hover:bg-white hover:text-paan-red shadow-lg hover:shadow-xl transform hover:-translate-y-1",
  ...
  return (
    <>
      <button
        onClick={() => {
          console.log("PartnerWithUsButton clicked");
          setShowModal(true);
        }}
