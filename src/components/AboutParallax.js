    ...
    return (
      <div className="relative w-full bg-slate-900 overflow-hidden h-[70vh] min-h-[500px]">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://ik.imagekit.io/nkmvdjnna/PAAN/about/parallax-image-min.png')`,
          }}
        />
        
        {/* overlay for better text readability - changed to darker gradient */}
        ...
        <div className="relative h-full flex mx-auto max-w-6xl z-20">
          <div className="max-w-6xl px-6 md:px-8 py-16 flex flex-col justify-center h-full">
            <div className="max-w-2xl text-left space-y-4">
              ...
              <p className="text-white text-base md:text-lg mb-6 font-light max-w-lg">
                From scattered local outputs to a unified continental powerhouse—capable of delivering global campaigns, shaping narratives, and influencing culture worldwide. We're not just building a network. We're building the foundation of a borderless African creative economy.
              </p>  
