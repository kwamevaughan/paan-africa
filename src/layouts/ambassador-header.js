            ...
            <div className="flex-1 px-4 py-6 space-y-3 bg-[#172840] overflow-y-auto">
              ...
              {freelancersMenu.map((item) => (
                <a
                  ...
                  href={item.href}
                  onClick={() => setIsMenuOpen(false)}
                  className="text-white hover:text-gray-900 hover:bg-[#F2B706] flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 text-base font-medium"
                >
